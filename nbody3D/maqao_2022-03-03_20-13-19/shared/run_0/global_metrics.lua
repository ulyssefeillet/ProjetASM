_report = {
  metrics = {
    ...
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.0016853753935,
    ...
    speedup_if_fully_vectorised = 1.0686,
    ...
    number_processes = 1,
    speedup_if_FP_only = 1.2703,
    nb_threads = 2,
    application_time = 4.41,
    compilation_options = "Not Available",
    innerloops_time = 99.83,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 4.405149 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 4.402503 seconds.",
  },
  colors = {
