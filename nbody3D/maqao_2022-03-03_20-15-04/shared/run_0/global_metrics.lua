_report = {
  metrics = {
    ...
    loops_time = 99.71,
    speedup_if_fp_vect = 1.0017,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.002882714729,
    ...
    speedup_if_fully_vectorised = 1.003,
    nb_loops_80_if_fp_vect = 2,
    flow_complexity = 1,
    speedup_if_clean = 1.0013,
    profiled_time = 3.5,
    array_access_efficiency = 95.833333333333,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 1.0025,
    nb_threads = 2,
    application_time = 3.5,
  ...
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 3.48985 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 3.4825 seconds.",
  },
  colors = {
