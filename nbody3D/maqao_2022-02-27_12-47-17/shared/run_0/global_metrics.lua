_report = {
  metrics = {
    ...
    speedup_if_fully_vectorised = 4.7129,
    ...
    number_processes = 1,
    speedup_if_FP_only = 1.5135,
    nb_threads = 1,
    application_time = 46.92,
  ...
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 46.910616 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 46.905924 seconds.",
  },
  colors = {
