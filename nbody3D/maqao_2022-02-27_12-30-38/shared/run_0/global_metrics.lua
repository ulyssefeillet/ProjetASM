_report = {
  metrics = {
    ...
    speedup_if_fully_vectorised = 9.6306,
    ...
    nb_threads = 1,
    application_time = 90.67,
    compilation_options = "Not Available",
    innerloops_time = 99.98,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 90.660933 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 90.651866 seconds.",
  },
  colors = {
