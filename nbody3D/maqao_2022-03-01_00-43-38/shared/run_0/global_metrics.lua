_report = {
  metrics = {
    ...
    speedup_if_fully_vectorised = 1.0841,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1,
    speedup_if_clean = 1,
    profiled_time = 12.14,
    array_access_efficiency = 12.5,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 1.5672,
    nb_threads = 1,
    application_time = 12.14,
    compilation_options = "Not Available",
    innerloops_time = 99.96,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 12.135144 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 12.135144 seconds.",
  },
  colors = {
