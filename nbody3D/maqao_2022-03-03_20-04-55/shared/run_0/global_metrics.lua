_report = {
  metrics = {
    ...
    speedup_if_fully_vectorised = 1.0707,
    ...
    number_processes = 1,
    speedup_if_FP_only = 1.272,
    nb_threads = 1,
    application_time = 9.06,
    compilation_options = "Not Available",
    innerloops_time = 99.67,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 9.05547 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 9.030102 seconds.",
  },
  colors = {
