_report = {
  metrics = {
    ...
    speedup_if_fully_vectorised = 1.0693,
    nb_loops_80_if_fp_vect = 2,
    flow_complexity = 1,
    speedup_if_clean = 1.0004,
    profiled_time = 9,
    array_access_efficiency = 99.986388888889,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 1.2716,
    nb_threads = 1,
    application_time = 9,
  ...
  help = {
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 8.9901 seconds.",
  },
  colors = {
