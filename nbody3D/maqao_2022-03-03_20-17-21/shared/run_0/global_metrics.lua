_report = {
  metrics = {
    ...
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.0016527269995,
    ...
    speedup_if_fully_vectorised = 1.0697,
    nb_loops_80_if_fp_vect = 2,
    flow_complexity = 1,
    speedup_if_clean = 1.0006,
    profiled_time = 4.5,
    array_access_efficiency = 99.981438747868,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 1.2713,
    nb_threads = 2,
    application_time = 4.5,
    compilation_options = "Not Available",
    innerloops_time = 99.45,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 4.48515 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 4.47525 seconds.",
  },
  colors = {
